...
namespace EntityHandlerBlueWorkerRole
{
    public class Server
    {
        ...
        private String externalEndpointName = "InputRequest_Blue";
        ...
        public void JobServer()
        {
            ...
            serviceHost.AddServiceEndpoint(typeof(IBlue1), binding, String.Format("net.tcp://{0}/{1}", roleInstance.IPEndpoint, externalEndpointName));
        }
