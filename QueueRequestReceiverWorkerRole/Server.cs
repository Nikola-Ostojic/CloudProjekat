...
namespace QueueRequestReceiverWorkerRole
{
    public class Server
    {
        ...
        private string externalEndpointName = "InputRequest_QueueRequest";
        ...
        public void JobServer()
        {
            ...
            serviceHost.AddServiceEndpoint(typeof(IQueueRequest), binding, String.Format("net.tcp://{0}/{1}", roleInstance, externalEndpointName));
